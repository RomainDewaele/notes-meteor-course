...
if (Meteor.isServer) {
  describe('notes', function () {
    ...
    describe('remove', function () {
      ...
      it('sould not remove note if invalid _id', function() {
        expect(() => {
    ...
    describe('update', function () {
      ...
      it('should update note body and title', function() {
        const title = 'updated title';
        const body = 'updated body';
        Meteor.server.method_handlers['notes.update'].apply({
          userId: noteOne.userId
      ...
      it('sould not update note if invalid _id', function() {
        expect(() => {
          Meteor.server.method_handlers['notes.update'].apply({userId: noteOne.userId}, [_id: "another id"]);
        }).toThrow();
      });
    ...
    describe('publication', function () {
      ...
      it('should return 0 notes for a user that has none', function() {
